...
export default function Navbar() {
  ...
  return (
    <div>
      <nav className="bg-gray-100 w-full max-w-screen px-4 py-4 mx-auto bg-opacity-90 sticky top-3 shadow lg:px-8 backdrop-blur-lg backdrop-saturate-150 z-[9999]">
        <div className="container flex flex-wrap items-center justify-between mx-auto text-slate-800">
          <Link
            href="/"
            className="mr-4 block cursor-pointer py-1.5 text-orange-400 font-bold text-2xl"
          >
            Montainesia
          </Link>
          ...
          >
            <div className="flex flex-row items-center border-b pb-4">
              <Link
                href="/"
                className="cursor-pointer text-orange-400 font-bold text-xl pt-4 ps-4"
              >
                Montainesia
              </Link>
              <button
            ...
            <ul className="flex flex-col h-full gap-4 p-4">
              {navItems.map((item, index) => (
                ...
                >
                  <Link
                    href={item.href}
                    className={`text-gray-900 rounded-md flex items-center ${
                      pathname === item.href
                        ? "bg-gray-900"
                        : "hover:bg-gray-700"
                    }`}
